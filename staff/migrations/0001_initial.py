    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ippis_no', models.PositiveIntegerField(blank=True, null=True, unique=True, validators=[staff.models.vMax, django.core.validators.MaxValueValidator(999999)], verbose_name='IPPIS number')),
                ...
                ('sfapt', models.FloatField(blank=True, max_length=300, null=True, verbose_name='salary_per_annum_at_date_of_first_appointment')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file_no', models.PositiveIntegerField(null=True, unique=True, validators=[staff.models.valMax, django.core.validators.MaxValueValidator(999999)], verbose_name='file number')),
                ...
                ('fnok_no', models.PositiveIntegerField(blank=True, null=True, verbose_name='first next of kin phone')),
                ...
                ('fnok_photo', models.ImageField(null=True, upload_to='')),
                ...
                ('snok_photo', models.ImageField(null=True, upload_to='')),
                ('timestamp', models.DateTimeField(auto_now_add=True, verbose_name='date added')),
                ('updated', models.DateTimeField(auto_now=True)),
                ('user', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('retire', models.BooleanField(blank=True, null=True)),
                ('rtb', models.CharField(blank=True, max_length=50, null=True, verbose_name='retired by')),
                ('timestamp', models.DateTimeField(auto_now_add=True, verbose_name='date added')),
                ('updated', models.DateTimeField(auto_now=True)),
                ('govapp', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='rtgovapp', to='staff.governmentappointment')),
                ('profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='profile', to='staff.profile')),
                ('user', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('due', models.BooleanField(blank=True, null=True)),
                ('timestamp', models.DateTimeField(auto_now_add=True, verbose_name='date added')),
                ('updated', models.DateTimeField(auto_now=True)),
                ('govapp', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='progovapp', to='staff.governmentappointment')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('granted', models.PositiveIntegerField(null=True, verbose_name='number of days granted')),
                ('status', models.CharField(blank=True, max_length=300, null=True)),
                ('lv', models.BooleanField(blank=True, null=True)),
                ('comments', models.TextField(blank=True, null=True, verbose_name='comments if any')),
                ('timestamp', models.DateTimeField(auto_now_add=True, verbose_name='date added')),
                ('updated', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestamp', models.DateTimeField(auto_now_add=True, verbose_name='date added')),
                ('updated', models.DateTimeField(auto_now=True)),
                ('govapp', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='execgovapp', to='staff.governmentappointment')),
