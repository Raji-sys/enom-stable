...
class GovFilter(django_filters.FilterSet):
    syear_of_fapt=django_filters.DateFilter(label="F_APT_START",field_name="governmentappointment__date_fapt__year",lookup_expr='lte',widget=forms.DateInput(attrs={'type':'date'}),input_formats=['%d-%m-%Y', '%Y-%m-%d', '%m/%d/%Y'])
    eyear_of_fapt=django_filters.DateFilter(label="E_APT_END",field_name="governmentappointment__date_fapt__year",lookup_expr='gt',widget=forms.DateInput(attrs={'type':'date'}),input_formats=['%d-%m-%Y', '%Y-%m-%d', '%m/%d/%Y'])
    ...
    syear_of_capt=django_filters.DateFilter(label="C_APT_START",field_name="governmentappointment__date_capt__year",lookup_expr='lte',widget=forms.DateInput(attrs={'type':'date'}),input_formats=['%d-%m-%Y', '%Y-%m-%d', '%m/%d/%Y'])
    eyear_of_capt=django_filters.DateFilter(label="C_APT_END",field_name="governmentappointment__date_capt__year",lookup_expr='gt',widget=forms.DateInput(attrs={'type':'date'}),input_formats=['%d-%m-%Y', '%Y-%m-%d', '%m/%d/%Y'])
    ...
    dep=django_filters.CharFilter(label="DEPT",field_name="governmentappointment__department",lookup_expr='iexact')
    ...
    qual=django_filters.CharFilter(label="qual",field_name="qualification__qual",lookup_expr='iexact')
    pro_qual=django_filters.CharFilter(label="pro_qual",field_name="professionalqualification__qual_obtained",lookup_expr='iexact')
